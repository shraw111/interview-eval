...
#
# HOW TO USE:
# 1. Copy this file to: deploy-config.sh
# 2. Fill in your actual values in deploy-config.sh
# 3. Run the deployment script: ./deploy-azure.sh
#
# The deploy-config.sh file is gitignored and will NOT be committed to Git.
# ============================================================================
